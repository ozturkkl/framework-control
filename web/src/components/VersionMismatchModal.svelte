...
<div class="modal modal-open">
  <div class="modal-box max-w-xl" role="dialog" aria-modal="true" tabindex="-1">
    <div class="flex items-start gap-3">
      <Icon icon="mdi:alert" class="w-8 h-8 text-warning " />
      <div class="space-y-2">
        <h3 class="font-bold text-lg">Please switch to the local app</h3>
        <p class="text-sm opacity-80">
          You're using the hosted web app while your local service has an update
          available. To avoid version mismatches, continue in the local app or
          update the service.
        </p>
